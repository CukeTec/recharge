$(function(){
  $('.storeListNew li').die().live('click',function(){
...
function load () {
    ...
    function pullDownAction(){
        setTimeout(function(){
            ...
            container.html('');
            $.ajax({
                url:'json/liststore.json',
                dataType:'json',
                success : function (data) {
                    $.each(data.data,function(i,item){
                        listli+='<li class="am-g am-list-item-desced am-list-item-thumb am-list-item-thumb-left">'
                            +'<div class="am-u-sm-4 am-list-thumb storeList">'
                            +'<a href="javascript:;" class="">'
                            +'<img src="'+item.img+'" alt="ddd" class="storeImg"/>'
                            +'</a>'
                            +'</div>'
                            +'<div class="am-u-sm-8 am-list-main">'
                            +'<h3 class="am-list-item-hd">'+item.title+'</h3>'
                            +'<div class="am-list-item-text listCon">'+item.content+'</div>'
                            +'<div class="am-list-item-text listTime">'
                            +'<img src="images/locationicon.png" alt="" class="am-margin-right locationIcon"/>'
                            +item.loc
                            +'</div>'
                            +'</div>'
                            +'</li>';
