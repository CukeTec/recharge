...
public class OrderInfoUtil2_0 {
    ...
    public static Map<String, String> buildAuthInfoMap(String pid, String app_id, String target_id, boolean rsa2) {
        ...
        // 服务接口名称， 固定值
        keyValues.put("apiname", ZfbUtil.ZFB_AUTH);

        // 商户类型标识， 固定值
        keyValues.put("app_name", ZfbUtil.ZFB_MERCHANT_TYPE);

        // 业务类型， 固定值
        keyValues.put("biz_type", ZfbUtil.ZFB_BUSINESS_TYPE);

        // 产品码， 固定值
        keyValues.put("product_id", ZfbUtil.ZFB_PRODUCT_ID);

        // 授权范围， 固定值
        keyValues.put("scope", ZfbUtil.ZFB_SCOPE_KUAIJIE);

        // 商户唯一标识，如：kkkkk091125
        keyValues.put("target_id", target_id);

        // 授权类型， 固定值
        keyValues.put("auth_type", ZfbUtil.ZFB_AUTH_TYPE);
